# NTU x WirForce 2026 — Budgeting Deck Brief

> **For:** Manus / deck designer — use this document to generate a complete budgeting presentation deck.
>
> **Audience:** NTU leadership, potential sponsors, WirForce partnership team
>
> **Tone:** Professional, data-driven, confident. Not overly detailed — high-level and optimized.
>
...
- Full campus takeover — not just a LAN party, but a multi-day festival
- NTU provides venues at no cost (auditoriums, lecture halls, green spaces)
- Existing campus infrastructure (power, Wi-Fi backbone, security) reduces costs
- Student volunteer programme offsets staffing

**Festival pillars:**
1. LAN Arena — the BYOC heart of the event
2. Esports — competitive tournaments with professional broadcast
3. Campus Programming — cosplay, LED Campfire, anisong, Showcase City, Screenverse
4. Overdex — smart wristband platform for entry, quests, and (at scale) cashless payments
...
The Alpha Launch deck budgeted $300K for 2,000 BYOC gamers (infrastructure-only). These new budgets cover the **full festival** and scale as follows:
- Infrastructure: high fixed costs → scales sub-linearly
- Broadcast: mostly fixed (same stream for 2K or 10K)
- Programming/talent: scales with scope, not headcount
- Security & ops: scales roughly linearly
- Marketing: scales with ambition

---

## 3. Core Costs — Always Included ($260,000)

These are non-negotiable regardless of tier:

| # | Item | Amount | One-Liner for Slide |
|---|------|--------|---------------------|
| 1 | Venue & Infrastructure | $120,000 | Power grid setup & industrial cabling, basic networking & internet uplinks, venue preparation & layout design |
| 2 | Operations & Safety | $90,000 | Base security team (24/7), on-site medical & first aid, H&S compliance & permits |
| 3 | Production Baseline | $50,000 | Signage & wayfinding, basic branding package, digital presence & comms |
...
|---|---------|--------|---------------------|
| 1 | Overdex Platform | $80,000 | Wristband hardware & encoding, event app (iOS/Android), beacon deployment (20+ nodes), quest engine & gamification |
| 2 | LAN Arena Network | $100,000 | Fiber backbone & core switches, VLAN segmentation (800+ ports), cable management & trunking, network monitoring & NOC |
| 3 | Esports Tournament | $140,000 | Main stage build & LED wall, side stage setup, tournament platform & admin, caster & analyst talent fees |
...
## 5. Budget Tier 1: "The Launch" — 5,000 Attendees

**Total: $600,000 SGD (~$120 per attendee)**

**Active modules:** Core ($260K) + LAN Arena ($100K) + Esports ($140K) + Broadcast ($100K)

**Positioning:** Lean, proven, impactful. Delivers the full WirForce experience at minimal viable scale.

**Key specs:**
- 800 BYOC seats in the LAN Arena
- Main stage + 1 side stage
- HD multi-camera broadcast
- Core activations only (no campus programming add-ons)
- Digital-first marketing (within Production Baseline)

---

## 6. Budget Tier 2: "Standard" — 7,500 Attendees

**Total: $850,000 SGD (~$113 per attendee)**

**Active modules:** Core ($260K) + Overdex ($80K) + LAN Arena ($100K) + Esports ($140K) + Broadcast ($100K) + Campus Activations ($90K) + Music & Entertainment ($80K)

**Positioning:** Comprehensive campus festival. The sweet spot for a flagship event.

**Key specs:**
- 1,000 BYOC seats in the LAN Arena
- Main stage + 1 side stage + rotating side programming
- HD multi-camera broadcast
- Overdex v1 (entry + quests)
- Core + music & campus activations
- Standard + expanded security
...
### 8.1 LAN Arena Network ($100,000)
- **Fiber backbone:** Core switches and fiber runs from NTU's grid to the LAN Arena
- **VLAN segmentation:** 800+ ports, isolated gaming traffic, low-latency routing
- **Cable management:** Trunking, under-desk routing for BYOC stations
- **NOC:** Network operations centre for real-time monitoring during the event

### 8.2 Esports Tournament ($140,000)
- **Main stage:** LED wall, sound system, player booths, caster desk
- **Side stage:** Secondary tournament area for grassroots titles
- **Tournament ops:** Bracket management, anti-cheat, referee teams
- **Talent:** Professional casters, analysts, hosts

### 8.3 Live Broadcast ($100,000)
- **Multi-camera:** 6+ camera rig for main stage coverage
- **Streaming:** Encoder & CDN for Twitch/YouTube distribution
- **Production:** Replay system, graphics overlays, lower thirds
- **Satellite:** Screens deployed across campus for viewing parties

### 8.4 Overdex Platform ($80,000)
- **Wristbands:** NFC-enabled, encoded at registration
- **Event app:** iOS/Android for schedule, map, quests, notifications
- **Beacons:** 20+ Bluetooth nodes for wayfinding and gamification
- **Quest engine:** Gamified campus exploration, sponsor interactions, rewards

### 8.5 Campus Activations ($90,000)
- **Cosplay:** Runway competition, photo zones, craftsmanship judging
- **LED Campfire:** Outdoor sleepover experience with LED installations, midnight programming
- **Showcase City:** FYP expo + art galleries + indie game showcases
- **Screenverse:** Lecture halls converted to cinema (anime, gaming docs, esports replays)

### 8.6 Music & Entertainment ($80,000)
- **Anisong:** Concert stage with anime song performers
...
## 9. Tier Comparison (For Deck Slide)
...
## 10. Revenue & Offset Model

All three tiers are designed to be offset by multiple revenue streams. Estimated recovery: **55–80% of total budget**.

**6 revenue streams (as % of total budget):**

| Revenue Stream | Low % | High % |
|---------------|:---:|:---:|
| Title sponsorship | 13% | 20% |
| Gold/Silver/Bronze sponsors | 13% | 17% |
| BYOC seat fees | 4% | 5% |
| General admission tickets | 8% | 14% |
| Exhibitor booth fees | 5% | 7% |
| F&B & merchandise | 3% | 7% |
...
## 11. Sponsorship Packages (SGD)

| Tier | Price Range | Slots | Key Benefits |
|------|:---:|:---:|-------------|
| **Title Sponsor** | $150,000–$300,000 | 1 exclusive | Event naming rights ("Presented by X"), main stage & all broadcast branding, keynote/demo slot at Opening Ceremony, premium booth (largest, prime location), all social media & marketing features, VIP passes & hospitality suite, post-event analytics & leads report |
| **Gold** | $50,000–$80,000 | 3 | Stage branding (1 stage), booth in Showcase City, social media feature posts, on-screen graphics & overlays, VIP passes (10), post-event recap inclusion |
| **Silver** | $20,000–$40,000 | 5 | Booth in designated zone, social media mentions, branding in 1 campus zone, general passes (20), logo on event materials |
| **Bronze** | $5,000–$15,000 | 10 | Logo placement on event materials, social media mention, product sampling opportunity, general passes (5) |
...
| Metric | Value |
|--------|:---:|
| Total Attendees | 5,000–10,000 |
| BYOC Gamers | 800–1,200 |
| Social Media Reach | 500K+ |
| Livestream Viewers | 50K+ |
| Gamer-Owned Hardware | $2M+ |
| Media Mentions | 100+ |

---

## 13. NTU Cost Advantages (Talking Point)

Use this as a "why the numbers work" talking point or slide:

1. **$0 venue rental** — NTU provides auditoriums, lecture halls, green spaces
2. **$0 hardware** — BYOC model means gamers bring $2M+ worth of rigs (at 10K)
3. **Existing infrastructure** — campus power grid, Wi-Fi backbone, security systems
4. **Student volunteers** — reduce professional staffing costs by 30–40%
5. **Academic alignment** — Showcase City features NTU student FYPs, Innovation Dome highlights NTU research
...
| Risk | Mitigation |
|------|-----------|
| Weather (outdoor zones) | Indoor backup venues available across NTU campus |
| Sponsor shortfall | Tier 1 designed to be viable with minimal sponsorship |
| Attendance below target | Scalable programming — can reduce zones without waste |
| Technical failure | Redundant power and networking in Full Scale tier |
| Safety incident | Professional medical on-site (ambulance at Full Scale), comprehensive H&S plan |

Budget includes a **~5% contingency buffer** within the Operations & Security line item.
...
- "This isn't a one-off event — it's the foundation for an annual fixture on Singapore's cultural calendar."

---

## 16. Suggested Deck Structure

For the colleague building the budgeting deck, here's a recommended slide flow:

| Slide | Title | Content |
|-------|-------|---------|
| 1 | Cover | NTU x WirForce 2026 — Budget Overview |
| 2 | The Opportunity | Why campus gaming festivals, why NTU, why now |
| 3 | Event at a Glance | 4 pillars: LAN Arena, Esports, Campus Programming, Overdex |
